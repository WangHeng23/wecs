...
template <template <typename...> typename ListType, typename T, typename... Ts, template <typename> typename F>
...
/**
 * @brief work as std::disjunction: use function struct F to check any of element is true
 * @tparam List
...
/**
 * @brief work as std::conjunction: use function struct F to check all of element is true
 * @tparam List
 * @tparam F  receive a type and give a constexpr static bool value;
 */
template <typename List, template <typename> typename F>
