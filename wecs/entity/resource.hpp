...
#include "wecs/core/singlton.hpp"
...
class resource_cache final
    : public singlton<resource_cache<T>, false, internal::default_construct_loader<resource_cache<T>>> {
public:
    ...
    type_const_reference get() const noexcept {
        WECS_ASSERT(data_, "resource not exist");
        return *data_;
    }
...
public:
    ...
    std::conditional_t<internal::is_mutable_v<T>, resource_reference_t, resource_const_reference_t>
